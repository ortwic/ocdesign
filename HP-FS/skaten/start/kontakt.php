  ...
  <tr height="40">
    <td colspan="2">
      ...
      <input type="submit" value="Absenden" class="cmd"
        ...
        onmouseout="this.className='cmdOut'"
        onmousedown="this.className='cmdDwn'"
        onmouseup="this.className='cmdOvr'">&nbsp;
...
<?php
  ...
  $send=0;
  $mail_text=$from_name.' schrieb am '.strftime('%A, den %d. %B %Y um %X Uhr').' von freestyleslalom.qu.am eine Feedback-Mail:
'.$mail_text;
